export default function SettingsBlackIcon() {
  return (
    <svg viewBox='0 0 16 16' className='w-8 h-8 text-gray-100' xmlns='http://www.w3.org/2000/svg'>
      <path
        fill='rgb(243 244 246 / var(--tw-text-opacity))'
