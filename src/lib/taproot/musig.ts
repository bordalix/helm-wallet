...
import { LiquidRefundDetails, TaprootUtils as LiquidTaprootUtils } from 'boltz-core/dist/lib/liquid'
...
export const createMusig = (ourKeys: ECPairInterface, theirPublicKey: Buffer, secp: Secp256k1ZKP) =>
...
export const tweakMusig = (asset: string, musig: Musig, tree: Taptree) =>
  (asset === 'L-BTC' ? LiquidTaprootUtils : TaprootUtils).tweakMusig(musig, tree)
