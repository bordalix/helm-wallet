...
export const serializeSwapTree = (tree: LiquidSwapTree): SerializedTree | SerializedLiquidSwapTree => {
...
export const deserializeSwapTree = (tree: string | SerializedTree | LiquidSwapTree): SwapTree | LiquidSwapTree => {
  ...
  const res: Omit<LiquidSwapTree, 'tree'> = {
    ...
    covenantClaimLeaf: parsed.covenantClaimLeaf !== undefined ? deserializeLeaf(parsed.covenantClaimLeaf) : undefined,
  }
